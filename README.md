...
stack layouts, native controls, an extern tooltip/mouse area, a clipboard task,
and an application event subscription:
...
This is an executable v0.3 language slice, not yet a complete iced replacement.
