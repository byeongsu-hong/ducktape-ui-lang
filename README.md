...
This is an executable v0.91 language slice, not yet a complete iced replacement.
...
status filtering, subscription context/filter transforms, structured
parallel/sequential tasks, system and clipboard
