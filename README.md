...
application event subscription, expanded boolean controls, and configured rules:
...
This is an executable v0.15 language slice, not yet a complete iced replacement.
