...
Ice 0.41 has three checked Rust boundaries:
...
| `Subscription` | partial | typed arbitrary iced `Subscription` adapters, batching, direct keyboard/window sources and system theme changes; other direct sources and combinators missing |
