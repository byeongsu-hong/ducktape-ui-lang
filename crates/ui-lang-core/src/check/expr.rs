...
pub(super) fn keyboard_variant<'a>(
    name: &str,
    args: &'a [Expr],
    span: &Span,
) -> Result<&'a str, Error> {
...
pub(super) fn check_builtin_args(
    name: &str,
    args: &[Expr],
    expected: &[Type],
...
pub(super) fn check_u32_literals(
    name: &str,
    args: &[Expr],
    span: &Span,
...
pub(super) fn check_u32_literal(name: &str, args: &[Expr], span: &Span) -> Result<u32, Error> {
...
pub(super) fn require_pixel_value(
    value: &Expr,
    env: &HashMap<String, Type>,
    document: &Document,
    span: &Span,
...
pub(super) fn require_radians_value(
    value: &Expr,
    env: &HashMap<String, Type>,
    document: &Document,
    span: &Span,
...
pub(super) fn arithmetic_type(left: &Type, op: BinaryOp, right: &Type) -> Option<Type> {
...
pub(super) fn contains_task_handle(ty: &Type) -> bool {
    match ty {
...
pub(super) fn contains_mouse_click(ty: &Type) -> bool {
    match ty {
