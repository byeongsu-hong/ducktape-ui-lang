...
component TrafficLights()
  row spacing=8.0 padding-left=18.0 height=34.0 align=center
    container width=13.0 height=13.0 background=stop radius=6.5
      text ""
    container width=13.0 height=13.0 background=caution radius=6.5
      text ""
    container width=13.0 height=13.0 background=go radius=6.5
      text ""
      ...
      if signed_in
        button label=profile_name width=fill padding=6.0 -> sign_in
          row spacing=9.0 align=center
            container width=26.0 height=26.0 align-x=center align-y=center background=card radius=13.0
...
component Cover(source:str, size:f64, radius:f64)
  container width=size height=size clip=true radius=radius
    image source width=size height=size fit=cover radius=radius
...
component PageHeader(title:str, subtitle:str)
  col spacing=3.0
    text title size=32.0 @text-foreground font-bold
...
component StationCard(album:Album)
  button label=album.title width=258.0 height=154.0 padding=0.0 clip=true -> play(album.title, album.artist, album.cover)
    stack width=258.0 height=154.0
      ...
      container width=258.0 height=154.0 padding=14.0 background=black/28
  ...
  button label=album.artist width=fill height=62.0 padding=7.0 -> play(album.title, album.artist, album.cover)
    row width=fill height=fill spacing=12.0 align=center
      ...
      col width=fill spacing=3.0
        text album.artist size=14.0 @text-foreground font-bold
  ...
  button label=album.title width=fill height=52.0 padding=6.0 -> play(album.title, album.artist, album.cover)
    row width=fill height=fill spacing=11.0 align=center
      ...
      col width=fill spacing=2.0
        text album.title size=13.0 @text-foreground
...
component QueueRow(album:Album, selected:bool)
  button label=album.title width=fill height=54.0 padding=5.0 -> play(album.title, album.artist, album.cover)
    row width=fill height=fill spacing=9.0 align=center
      ...
      col width=fill spacing=2.0
        text album.title size=12.0 wrapping=none @text-foreground font-bold
  ...
  container width=304.0 height=fill padding=16.0 background=surface border=border border-width=1.0 radius-tl=14.0 radius-bl=14.0 shadow=black/18 shadow-x=-4.0 shadow-blur=14.0
    col width=fill height=fill spacing=10.0
      row width=fill align=center
        text "Playing Next" width=fill size=18.0 @text-foreground font-bold
...
component PlayerBar(title:str, artist:str, cover:str, active:bool, playhead:f64, loudness:f64)
  stack width=654.0 height=54.0
    ...
    container width=654.0 height=54.0 padding=8.0 background=transparent border=white/45 border-width=1.0 radius=27.0 shadow=black/20 shadow-y=3.0 shadow-blur=14.0
      row width=fill height=fill spacing=8.0 align=center
        ...
        col width=fill spacing=1.0
          row width=fill
            text title width=fill size=12.0 wrapping=none @text-foreground font-bold
            text "•••" size=11.0 @text-muted
...
view
  container width=fill height=fill clip=true background=background radius=20.0
